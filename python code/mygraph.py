...
#					list[i]=list[i][1:len(list1)-2]
			elif (i==2):
				list1[i]=list1[i].replace("(","")
				list1[i]=list1[i].replace(",","")
					
#					list3.append(list1[i][1:len(list1)-1])
#					list[i]=list[i][1:len(list1)-1]
#					print list3[i]

			else : 
				list1[i]=list1[i].replace(",","")
#					list3.append(list1[i][0:len(list1)-1])
			list3.append(list1[i][0:len(list1)])

#					x=list[i][1:len(list1)-1]
#				list[i]=list[i].replace(",","")
#				print list3
